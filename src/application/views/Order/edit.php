    ...
    <div class="w-75 card card-primary">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <textarea name="observations" class="form-control" id="formInpObservations" rows="3" placeholder="Observações..."><?= $order->observations ?></textarea>
            </div>
        </div>
            ...
            <?php foreach ($orderProducts as $index => $orderProduct) : ?>
                ...
                <div id="divProduct-<?= $sequence ?>" class="w-100 row div-products" data-sequence="<?= $sequence  ?>">
                    <div class="col-6">
                        <div class="form-group">
                            <label>Produto*</label>
                            <select name="inpSelectProduct-<?= $sequence ?>" class="form-control select2 product-input" id="inpSelectProduct-<?= $sequence ?>" style="width: 100%;" required>
                                <option value=""></option>
                    ...
                    <div class="col">
                        <div class="form-group">
                            <label>Valor*</label>
                            <input type="text" value="<?= $orderProduct->unitPrice ?>" name="inpValue-<?= $sequence ?>" id="inpValue-<?= $sequence ?>" class="form-control form-control-border product-input" placeholder="Valor" required>
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                            <label>Quantidade*</label>
                            <input type="text" value="<?= $orderProduct->quantity ?>" name="inpQuantity-<?= $sequence ?>" id="inpQuantity-<?= $sequence ?>" class="form-control form-control-border product-input" placeholder="Quantidade" required>
                        </div>
                    </div>
                    <div class="col-auto">
