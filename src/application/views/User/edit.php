    ...
    <div class="w-50 card card-info">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" name="phone" value="<?= $user->phone ?>" class="form-control form-control-border input-mask-phone" id="formInpPhone" placeholder="Telefone" required <?= !$user->active ? 'disabled' : '' ?>>
            </div>
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_1">
                            <div class="form-group">
                                ...
                                <input type="text" name="firstZipCode" value="<?= isset($firstAddress) ? $firstAddress->zipCode : '' ?>" class="form-control form-control-border input-mask-zipcode" id="formInpFirstZipCode" placeholder="CEP" required <?= !$user->active ? 'disabled' : '' ?>>
                            </div>
                            <div class="row">
                                <div class="col-8">
                                    <div class="form-group">
                        ...
                        <?php if ($totalNeededAdresses > 1) : ?>
                            <div class="tab-pane" id="tab_2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="secondZipCode" value="<?= isset($secondAddress) ? $secondAddress->zipCode : '' ?>" class="form-control form-control-border input-mask-zipcode" id="formInpSecondZipCode" placeholder="CEP" required <?= !$user->active ? 'disabled' : '' ?>>
                                </div>
                                <div class="row">
                                    <div class="col-8">
                                        <div class="form-group">
